...
const teenMahinayBeroon = () => {
 ...
 const handleSubmit = async () => {
   ...
   try {
     // Save to Firestore
     await addDoc(collection(db, "teenMahinayMastoraat"), {
       name,
       masjidName,
       year,
       time,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>۳ مہینے مستورات فارم</Text>
...
export default teenMahinayBeroon;
