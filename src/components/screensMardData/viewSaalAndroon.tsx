...
const ViewSaalAndroon = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "saalAndroon"));
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>سال اندرون ڈیٹا</Text>
      <FlatList
        data={data}
...
export default ViewSaalAndroon;
